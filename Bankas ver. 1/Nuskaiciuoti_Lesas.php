...
<body>
    <div class="bg_img"></div>
        <div class="z_position">
            ...
            //Pinigų Nuemimas prie esamos sąskaitos sumos
                ...
                <form class="m-2 mt-5 mb-5 " method="POST" action="">
                    ...
                    <div class="row mt-1 me-2">
                        <div class="col-md-1"></div>
                        <div class="col-md-2 mb-3 rounded">
                            <p class="fw-bold text-center"> Nuskaičiuoti lėšas</p>
                        </div>
                        <div class="col-7 mb-3">
                            <input type="text" class="form-control" id="nsuk-lesas" name="saskaita[sub_lesos]">
                        </div>
                    </div>
                    <div class="row mt-3 me-2">
        ...
        <!-- Paieška pagal IBAN -->
                <?php else :
                    if( isset($_POST['iban']) && strlen($_POST['iban']) == 20){
                        ...
                        header("Location: ./Nuskaiciuoti_Lesas.php?id=$db_key");

                    }elseif(isset($_POST['iban'])){
                        $_POST = [];
                        header('Location: ./Nuskaiciuoti_Lesas.php?status=3.5');
                    }
                    ?>
